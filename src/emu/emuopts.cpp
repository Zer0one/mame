...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_JOYSTICK_SATURATION ";joy_saturation;jsat(0.00-2.00)",  "0.85", core_options::option_type::FLOAT,  "end of axis saturation range for joystick where change is ignored (0.0 center, 1.0 end)" },
